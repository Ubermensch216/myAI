...
export const elements = {
  ...
  imageGenButton: document.querySelector("#imageGenButton"),
  imageGenActiveButton: document.querySelector("#imageGenActiveButton"),
  imageGenPanel: document.querySelector("#imageGenPanel"),
  imageGenStyle: document.querySelector("#imageGenStyle"),
  imageGenRatio: document.querySelector("#imageGenRatio"),
  imageGenCount: document.querySelector("#imageGenCount"),
  ...
  studioInfographicRailButton: document.querySelector("#studioInfographicRailButton"),
  ...
  studioInfographicButton: document.querySelector("#studioInfographicButton"),
  ...
  studioInfographicPanel: document.querySelector("#studioInfographicPanel"),
  ...
  statsImageStatus: document.querySelector("#statsImageStatus"),
