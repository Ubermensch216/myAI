...
export const elements = {
  ...
  packTabs: Array.from(document.querySelectorAll(".pack-tab")),
  packTabPanels: Array.from(document.querySelectorAll(".pack-tab-panel")),
  packManageAuthHint: document.querySelector("#packManageAuthHint"),
  packOpenAdminNotebooksButton: document.querySelector("#packOpenAdminNotebooksButton"),
