...
export const elements = {
  ...
  adminGraphButton: document.querySelector("#adminGraphButton"),
  adminGraphPanel: document.querySelector("#adminGraphPanel"),
  kgNotebookSelect: document.querySelector("#kgNotebookSelect"),
