...
export const elements = {
  ...
  lawWorkbenchOutputType: document.querySelector("#lawWorkbenchOutputType"),
  lawWorkbenchConditionText: document.querySelector("#lawWorkbenchConditionText"),
  lawWorkbenchReportTemplate: document.querySelector("#lawWorkbenchReportTemplate"),
  lawWorkbenchRunButton: document.querySelector("#lawWorkbenchRunButton"),
  lawWorkbenchReportButton: document.querySelector("#lawWorkbenchReportButton"),
