...
const cases = [
  ...
  ["개인정보 보호법 제15조 위반 시 단계별 대응 방안 알려줘", true, {}, "PIPA + 단계별 대응 → action_plan"],
  ["근로기준법 제53조 이행 계획을 단계별로 정리해줘", true, {}, "근로기준법 + 이행 계획 → action_plan"],
  ["민법 제750조 손해배상 조치 절차", true, {}, "민법 + 조치 절차 → action_plan"],
  ["도로교통법 제44조 위반 시 컴플라이언스 체크리스트", true, {}, "도로교통법 + 컴플라이언스 → action_plan"],
  ["이번 분기 프로젝트 단계별 실행 계획 짜줘", false, {}, "프로젝트 계획 — 법령 근거 없음"],
  ["주말 여행 대응 방안 알려줘", false, {}, "여행 — 법령 근거 없음"],
  ["다이어트 단계별 실행 계획", false, {}, "다이어트 — 법령 근거 없음"]
];
